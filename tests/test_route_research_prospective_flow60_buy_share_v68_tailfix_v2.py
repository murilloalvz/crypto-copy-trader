...
import route_research_prospective_flow60_buy_share_holdout_v68_tailfix_v2 as wrapper


class V68TailfixV2WrapperTests(unittest.TestCase):
    def test_wrapper_installs_only_tailfix_systems_path_and_restores(self):
        ...
        self.assertIs(observed["smoke"], wrapper.tailfix_v2.run_smoke_tailfix_v2)
        self.assertEqual(observed["profile"], wrapper.TAILFIX_V2_SYSTEMS_PROFILE)
