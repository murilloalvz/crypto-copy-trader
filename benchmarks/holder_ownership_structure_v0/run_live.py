...
VERSION = "launch_burst_holder_ownership_structure_v0"
PASS_CLASSIFICATION = "PASS_LAUNCH_BURST_HOLDER_OWNERSHIP_STRUCTURE_V0"
FAIL_CLASSIFICATION = "FAIL_LAUNCH_BURST_HOLDER_OWNERSHIP_STRUCTURE_V0"
...
def _compact(report: dict) -> dict:
    ...
    return {
        ...
        "holder_ownership_structure_v0": holder,
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Prospective no-capital Holder Ownership Structure V0 acquisition"
    )
    ...
    if int(args.duration_seconds) != 900:
        print(json.dumps({
            ...
            "error": "Holder Ownership Structure V0 duration is frozen at 900 seconds",
        }, indent=2))
        return 2
    ...
    try:
        ...
        with patched_holder_ownership_structure_v0(api_key=gmgn_key) as holder_runtime:
            base = asyncio.run(
                run_sim_v4(
        ...
        evidence_path = run_dir / "holder-ownership-structure-v0-evidence.json"
        ...
        wrapper_path = run_dir / "simulation-report-v4-holder-ownership-v0.json"
        report = {
            "type": "launch_burst_holder_ownership_structure_report_v0",
            "version": VERSION,
            ...
            "artifacts": {
                **dict(base.get("artifacts") or {}),
                ...
                "holder_ownership_structure_v0_evidence": str(evidence_path.resolve()),
        ...
        print(json.dumps({
            "classification": FAIL_CLASSIFICATION,
            "error": sim._redacted_error(exc, helius_key, jupiter_key, rpc_url, gmgn_key),
        }, indent=2))
        return 2
